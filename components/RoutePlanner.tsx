...
import { MapPin, Navigation, Loader2, Footprints, Car, CloudRain, Sparkles, ScrollText, Sword, Search } from 'lucide-react';
...
const STYLES: { id: StoryStyle; label: string; icon: React.ElementType; desc: string }[] = [
    { id: 'HISTORY_PODCAST', label: 'History Podcast', icon: Search, desc: 'Real facts and local legends about your path.' },
...
const RoutePlanner: React.FC<Props> = ({ onRouteFound, appState, externalError }) => {
  ...
  const [selectedStyle, setSelectedStyle] = useState<StoryStyle>('HISTORY_PODCAST');
